...
jsonSource_sede_navegacao_15.addFeatures(features_sede_navegacao_15);
...
lyr_sede_navegacao_15.set('fieldAliases', {'fid': 'fid', 'Codigo': 'Código Imóvel', 'nome': 'Nome', 'proprietar': 'Prorprietário', 'google_map': 'Google Mapas', 'waze': 'Waze', 'ygms': 'Latitude', 'xgmsg': 'Longitude', });
...
lyr_sede_navegacao_15.set('fieldImages', {'fid': 'TextEdit', 'Codigo': 'TextEdit', 'nome': 'TextEdit', 'proprietar': 'TextEdit', 'google_map': 'TextEdit', 'waze': 'TextEdit', 'ygms': 'TextEdit', 'xgmsg': 'TextEdit', });
...
lyr_sede_navegacao_15.set('fieldLabels', {'fid': 'no label', 'Codigo': 'header label', 'nome': 'inline label', 'proprietar': 'inline label', 'google_map': 'inline label', 'waze': 'inline label', 'ygms': 'no label', 'xgmsg': 'no label', });
